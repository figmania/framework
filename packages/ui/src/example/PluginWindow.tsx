...
export interface PluginWindowProps extends PropsWithChildren {
  title: string
}

export const PluginWindow: FunctionComponent<PluginWindowProps> = ({ children, title }) => {
  return (
    <div className={clsx(styles['window'], 'plugin-ui-window')}>
