...
export const PluginWindow: FunctionComponent<PluginWindowProps> = ({ children, title, className, ...props }) => {
  return (
    <div className={clsx(styles['window'], 'plugin-ui-window', className)} {...props}>
