...
import { Accordion, Button, ButtonGroup, Checkbox, Code, Icon, Input, Navbar, Select, SelectOption, Theme, ThemeType } from '..'
import './index.scss'
      ...
      <Theme className='container' theme={this.state.theme}>
        ...
        <div className="panel">
          <Navbar icon="ui-clipboard" title="Navbar with Buttons">
            <Button icon="ui-clipboard" title="Copy"></Button>
