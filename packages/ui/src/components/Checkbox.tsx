...
export const Checkbox: FunctionComponent<CheckboxProps> = ({ id, className, isDisabled, title, name, value, onChange, ...props }) => {
  ...
  return (
    <div className={clsx(styles['checkbox'], className)} {...props}>
      <input type="checkbox" id={inputId} checked={value} disabled={isDisabled} onChange={(event) => {
